...
def data_synthetic_pendulum(kapa: float, b: float, timesteps: int = 50, maxtime: float = 5.0, m: float = 1.0, A0: float = 1.0, phi: float = 0.0, t: np.array = None) -> np.array:
    """
...
def plot_synthetic_pendulum(timeserie: np.array, timeserienext: np.array, question: float, answer: float, timesteps: int = 50, maxtime: float = 5.0) -> None:
    """

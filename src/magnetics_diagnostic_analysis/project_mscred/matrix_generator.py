...
parser.add_argument('--train_end_point',  type = int, default = 20000,
						help = 'train end point')
parser.add_argument('--test_start_point',  type = int, default = 20000,
						help = 'test start point')
parser.add_argument('--test_end_point',  type = int, default = 20000,
						help = 'test end point')
parser.add_argument('--raw_data_path', type = str, default = './data/healthy_no_anomaly.csv',
...
def generate_train_test_data():
	...
	for i in range(len(train_test_time)):
		for data_id in range(int(train_test_time[i][0]/gap_time), int(train_test_time[i][1]/gap_time)):
			...
			print(len(multi_matrix))
			print(multi_matrix[0].shape)
